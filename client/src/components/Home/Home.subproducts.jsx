...
import { getProductsFiltered, getSubCategoriesProducts } from "../../redux/actions";
...
export default function HomeSubProducts() {
  ...
  const products = useSelector((state) => state.subcategoriesproducts);
  ...
  return (
    <>
      ...
      <section className="px-16 mb-16">
        ...
        <div className="flex flex-col lg:flex-row gap-3 justify-center bg-white">
                ...
                <div className="flex flex-col gap-2">
                  {ad.map((brands) => (
                    <div className="flex gap-2 items-center">
                      <input type="checkbox" value={brands.brand} name={brands.brand} onClick={(ev) => handleBrand(ev)}></input>
